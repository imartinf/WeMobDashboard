...
# For deployment outside this notebook comment above
import dash
...
def create_and_run_app(df_s:pd.DataFrame):
    ...
    # Let us now create the app, using Dash BOOTSTRAP and HTML

    app = dash.Dash(__name__, external_stylesheets=[dbc.themes.MINTY])

    # First up we declare CSS Style variables

    style_file = '/Users/imartinf/Documents/UPM/MUIT_UPM/BECA/CODE/WeMobDashboard/src/style.json'

    with open(style_file, 'r') as file:
        style = json.load(file)
    # the style arguments for the sidebar.
    SIDEBAR_STYLE = style["SIDEBAR_STYLE"]
